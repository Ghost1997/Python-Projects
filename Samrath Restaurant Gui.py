...
lblInfo = Label(Tops, font=('arial',50,'bold'),text="Samrath Restaurant Billing System",fg="steel Blue",bd=10,anchor='w')
...
lbl_fries = Label(f1,font=('arial',16,'bold'), text="Chilli Paneer",bd=16,anchor='w')
...
lbl_Gualbjamun = Label(f1,font=('arial',16,'bold'), text="Tanduri Roti",bd=16,anchor='w')
...
lbl_vegmomo = Label(f1,font=('arial',16,'bold'), text="Chilli Chicken",bd=16,anchor='w')
...
lbl_Eggroll = Label(f1,font=('arial',16,'bold'), text="Butter Paneer",bd=16,anchor='w')
...
lbl_Sand = Label(f1,font=('arial',16,'bold'), text="Chicken Biryani",bd=16,anchor='w')
...
lbl_Drinks = Label(f1,font=('arial',16,'bold'), text="Beer",bd=16,anchor='w')
